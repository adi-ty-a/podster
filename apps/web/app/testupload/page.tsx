...
export default function FeatureSection() {
    ...
    return <div className="bg-[#F0F3F5] w-screen h-[700px] flex flex-col items-center py-[70px] ">
        <div className="  text-[48px] font-bold text-center bg-gradient-to-b from-black to-[#999999] bg-clip-text text-transparent [text-shadow:0px_3px_2.3px_rgba(0,0,0,0.09)]">How Podster works</div>
        <div className="  flex w-fit gap-10 mt-[100px]">
            {/* box */}
            <div className="relative w-[300px] h-[300px] bg-white rounded-[42px] flex items-center justify-center">
                <div className="absolute text-[42px] bg-gradient-to-b  from-[#D04343] to-[#EC8787] text-white size-fit px-5 py-0 -top-8 left-1/2 rounded-full transfrom: -translate-x-1/2 ">1</div>
            ...
            <div className="relative w-[300px] h-[300px] bg-white rounded-[42px] flex items-center justify-center">
                <div className="absolute text-[42px] bg-gradient-to-b  from-[#D04343] to-[#EC8787] text-white size-fit px-5 py-0 -top-8 left-1/2 rounded-full transfrom: -translate-x-1/2 ">2</div>
                <div className="flex flex-col justify-between h-full">
            ...
            <div className="relative w-[300px] h-[300px] bg-white rounded-[42px] flex items-center justify-center">
                <div className="absolute text-[42px] bg-gradient-to-b  from-[#D04343] to-[#EC8787] text-white size-fit px-5 py-0 -top-8 left-1/2 rounded-full transfrom: -translate-x-1/2 ">3</div>
                <div className="flex flex-col justify-between h-full">
